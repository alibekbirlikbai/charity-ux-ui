...
import './css/MyDonations_NOT_RESPOND_Page.css';
...
export default function User_MyDonations_NOT_Respond_Page() {
  ...
  return (
    <div class="wrapper   user_mode   myDonations" id='myDonations_NOT_Respond_Page'>
                    ...
                    <div class="content">
                        ...
                        <div class="content__body">                            
                            <div class="content-title-select-box">
                                <a href="/user/my-donations/not-respond" class="active">Not-Respond</a>

                                <a href="/user/my-donations/respond">Respond</a>
                                
                                <a href="/user/my-donations/done_(archived)">Done (Archived)</a>
                            </div>
