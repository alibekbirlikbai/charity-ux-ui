...
import './css/log-In (Organization).css';

import img_logo from '../../(general)/img (general)/logo.png';
import icon_arrow_left from '../../(general)/img (general)/arrow-left.png';

export default function Login_Organization () {
  return (
    <div class="wrapper   auth   login_logup   login" id='login_organization'>
        <div class="HEADER">
            ...
            <div class="container">
                ...
                <div class="container__main">
                    ...
                    <div class="container__titles">
                        ...
                        <div>
                            <a href="/auth/logup/organization">Log up</a>
                        </div>
                    </div>
                            ...
                            <form  class="sending__form" action="">
                                ...
                                <div class="button-box flex-2-row">
                                    <button class="button-logIn">
                                        <a href="/organization/home/donation-List">LOG IN</a>
                                    </button>
