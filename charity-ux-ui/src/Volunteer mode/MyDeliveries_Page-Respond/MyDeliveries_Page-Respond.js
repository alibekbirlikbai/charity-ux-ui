...
import "./css/MyDeliveries_Page-Respond.css";
...
export default function Volunteer_MyDeliveries_Page_Respond() {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function myFunction() {
            if (window.pageYOffset >= 225) {
                ...
                document.querySelector(".myDonations-flex-box").style.paddingTop = "60px";
  ...
  return (
    <div class="wrapper  volunteer_mode" id="myDeliveries_Page_Respond">
        <div class="SIDEBAR">
                ...
                <div class="container__main">
                    <div class="content">
                        ...
                        <div class="content-title-select-box">
                                <a href="/volunteer/deliveries/respond" class="active">Respond</a>

                                <a href="/volunteer/deliveries/in-process_(delivery)">In-Process_(Delivery)</a>
                                                ...
                                                <div class="box-action-container">
                                                    <div class="edit-content-action">
                                                        <button class="edit-button">
                                                            <a href="">Start Delivery</a>
                                                        </button>
                                                    </div>

                                                    <div class="delete-content-action">
                                                        <button class="delete-button">
                                                            <a href="">Decline Delivery</a>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
