...
import "./css/MyDonationsPage-Respond.css";
...
export default function Organization_MyDonations_Page_Respond() {
  ...
  return (
    <div class="wrapper   organization_mode   myDonations" id='myDonations_Page_Respond'>
        <div class="SIDEBAR">
                    ...
                    <div class="content">
                        ...
                        <div class="content__body">                            
                            <div class="content-title-select-box">
                                <a href="/organization/donations/respond" class="active">Respond</a>
                            ...
                            <div class="content-box">                                
                                ...
                                <div class="page-mapping-box">
                                    <p class="page-mapping-text">Show 1 to 3 of 30 entities</p>
