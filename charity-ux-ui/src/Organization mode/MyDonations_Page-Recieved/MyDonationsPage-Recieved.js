...
import "./css/MyDonationsPage-Recieved.css";
...
export default function Organization_MyDonations_Page_Recieved() {
  ...
  return (
    <div class="wrapper   organization_mode   myDonations" id='myDonations_Page_Recieved'>
        <div class="SIDEBAR">
                                                ...
                                                <div class="box-action-container">
                                                    <div class="make_report-content-action">
                                                        <button class="make_report-button">
                                                            <a href="/organization/donations/recieved/make-donation_report">Make report</a>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
