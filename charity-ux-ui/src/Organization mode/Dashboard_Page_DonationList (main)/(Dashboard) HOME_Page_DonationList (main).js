...
import "./css/(Dashboard) HOME_Page_DonationList (main).css";
...
export default function Organization_HOME_Page_DonationList () {
  ...
  return (
    <div class="wrapper   organization_mode" id='home_Page_DonationList'>
        <div class="SIDEBAR">
                ...
                <div class="content">
                    ...
                    <div class="footer__container">
                        <div class="copyright__container">
                            <p class="copyright-text">© 2022-2023, "QaiyrAmanat"</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="content__body">                            
                            <div class="content-title-select-box">
                                <a href="/organization/home/donation-List" class="active">Donation-list</a>

                                <a href="/organization/home/specific-donation-List">Specific-Donation</a>                                
                            </div>
                                        ...
                                        <div class="myDonations-box">
                                            ...
                                            <div class="box-action">
                                                ...
                                                <div class="box-action-container">
                                                    <div class="respond-content-action">
